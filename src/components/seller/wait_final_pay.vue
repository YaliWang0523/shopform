  ...
  <div>
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="../index.html">待收尾款</a>
        <!-- User -->
    ...
    <div class="container-fluid mt--7">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <table class="table align-items-center table-flush">
                <tr>
                  <td><strong class="mr-2">付款方式</strong>{{datas['PayType']}}</td>
                  <td><strong class="mr-2">銀行</strong>{{datas['Bank']}}</td>
      ...
      <!-- /Card Row1 -->
    <button v-on:click="WaitFinalPaySetData()" class="btn btn-primary btn-lg my-3" role="button" aria-pressed="true">收到尾款</button>
    <!-- /Card Row3 -->
  </div>
</div>
</div>
...
export default {
  ...
  methods: {
    ...
    WaitFinalPaySetData: function () {
      this.saveData()
    },
    onSaveHandle: function (data) {
      this.datas = data[0]
      this.$router.replace({name: 'seller_list', params: {info: '121'}})
    },
